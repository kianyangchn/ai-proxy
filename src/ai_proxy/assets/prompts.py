...
SYSTEM_INSTRUCTIONS = (
    ...
    "4) Extract (meat or vegetable type, important to specify what kind of meat or vegetable it is) and (flavor, spicy, sweet, salty, etc.) from the text that describe the dish as tags. Tags should be short and concise, just one word, and in the translated language. "
